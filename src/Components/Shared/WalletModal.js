...
const WalletModal = () => {
  const { connectToMetamask, walletModal, openCoinbaseModal, closeWalletModal, } = useContext(DSLCommerceContext);
              ...
              <Row xs={1} md={1} className="g-2">
                <Col>
                  <Card className='walletDiv walletModal_icon'>
                    ...
                    <Card.Body>
                      <Card.Title className='walletName'>Metamask</Card.Title>
                      <button className='border-0 text-light rounded pt-1 pb-1' style={{ backgroundColor: "#ff6c09" }} onClick={() => connectToMetamask()}>Click here to Login</button>
