...
const KycPhotoId = () => {
  return (
    <div className='' >
      <div className='mt-3' style={{ background: '#fff', padding: '10px 20px', borderRadius: '3px' }}><p className='text-danger'>Note: If you change your ID with photo, your account will be downgraded till our admin approves it.</p></div>
      ...
      <Form className='default-width-container'>
        ...
        <Form.Group className="mb-3 " controlId="formBasicEmail">
          ...
          <Button className='my-4 text-uppercase' as="input" type="submit" value="Submit" />
